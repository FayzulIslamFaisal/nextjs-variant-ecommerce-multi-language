...
const Search = () => {
    ...
    return (
        <form action="/search" method="GET" className=" flex items-stretch h-10 ">
            ...
            <Input className="flex-1 rounded-none dark:border-gray-200 bg-gray-100 text-black border-r border-none py-2 h-[40px] " placeholder="Search..." name="q" type="search" />
